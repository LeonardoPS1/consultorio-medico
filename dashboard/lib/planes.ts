...
export const PLANES: Record<PlanId, PlanInfo> = {
  ...
  starter: {
    ...
    features: [
      ...
      'Solicitudes de datos (Ley 19.628) - exportación y eliminación',
      '1 profesional',
    ],
    cta: 'Suscribirse',
  },
  ...
  premium: {
    ...
    features: [
      ...
      'Portal del paciente (turnos, recetas, historial y documentos)',
  ...
  enterprise: {
    ...
    features: [
      'Todo lo de Premium +',
      'Multi-sucursal / Multi-tenant con RLS',
      'Panel de administración global con métricas por sucursal',
      'Derivaciones cross-tenant con consentimiento del paciente',
      'Convenios de intercambio entre organizaciones',
      'Consentimiento compartido granular entre centros',
      'Integraciones personalizadas (Dentalink, Medilink, Doctoralia)',
      'Onboarding asistido por IA con configuración regional',
      'Monitoreo avanzado de rendimiento por sucursal',
      'Carga masiva de pacientes vía Excel/CSV',
      'White-labeling (dominio custom, colores de marca)',
      'Configuración regional (CL/AR) con moneda y formatos',
      'Previsión de salud chilena (FONASA 4 tramos + 15 ISAPREs)',
      'Disaster Recovery (backups off-site, drills automatizados)',
      'Hardening de impersonación (revocación sesión, auditoría)',
      'Consola de incidentes y gestión de tenants',
      'Creación de clínicas desde Ops Console',
