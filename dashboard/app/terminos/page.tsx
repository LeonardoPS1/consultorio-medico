      ...
      <main className="container mx-auto px-4 md:px-6 py-12 md:py-16 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                AiCoreMed cumple con la Ley 19.628 de Chile sobre protección de datos personales.
                Todos los datos de salud se tratan bajo estrictas medidas de seguridad: cifrado
                AES-256, autenticación con 2FA, IA local sin acceso externo, y backup encriptado
                diario. Tus pacientes están protegidos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          <section>
            ...
            <p>
              Al acceder o utilizar la plataforma AiCoreMed (en adelante, &laquo;la
              Plataforma&raquo;), usted acepta estar sujeto a estos Términos del Servicio. Si no
              está de acuerdo con alguna parte de los términos, no podrá acceder a la Plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              AiCoreMed es un sistema de gestión para consultorios médicos que proporciona
              herramientas para:
            </p>
          ...
          <section>
            ...
            <p>
              El profesional médico o la institución que utiliza la Plataforma es el{' '}
              <strong>Responsable del Tratamiento</strong> de los datos de salud de sus pacientes,
              según lo definido por las leyes de protección de datos aplicables.
            </p>
            ...
            <p>
              Aicore actúa como <strong>Encargado del Tratamiento</strong>, procesando los datos
              personales según las instrucciones del profesional médico y bajo estrictas medidas de
              seguridad.
            </p>

            <h3 className="text-base font-medium text-foreground mt-4 mb-2">
              3.3 Obligaciones del Profesional
            </h3>
            <ul className="list-disc pl-5 space-y-1 text-sm">
              <li>
                Obtener el consentimiento informado de sus pacientes para el uso de la Plataforma
              </li>
          ...
          <section>
            ...
            <p>
              La Plataforma, incluyendo su código, diseño, logotipos y contenido, es propiedad
              exclusiva de Aicore y está protegida por leyes de propiedad intelectual. El usuario
              obtiene una licencia limitada, no exclusiva e intransferible para usar la Plataforma
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm">
              <li>
                Ofrecemos planes gratuitos y de pago con diferentes niveles de funcionalidades
              </li>
              <li>Los planes de pago se facturan mensualmente en USD a través de MercadoPago</li>
              <li>
                Puede cancelar su suscripción en cualquier momento desde el panel de configuración
              </li>
          ...
          <section>
            ...
            <p>
              AiCoreMed se proporciona &laquo;tal cual&raquo; y &laquo;según disponibilidad&raquo;.
              Aicore no será responsable por:
            </p>
            <ul className="list-disc pl-5 space-y-1 text-sm">
              <li>
              ...
              <li>
                Decisiones médicas basadas en la información proporcionada por el asistente IA
              </li>
              <li>
                Interrupciones del servicio por mantenimiento, fuerza mayor o problemas de terceros
              </li>
              <li>
                Pérdida de datos por causas ajenas a nuestra voluntad (siempre mantenemos backups)
              </li>
            </ul>
            <p className="text-sm mt-3">
              El asistente de IA es una <strong>herramienta de apoyo</strong> y no reemplaza el
              criterio profesional del médico. Todas las decisiones médicas son responsabilidad
              exclusiva del profesional tratante.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm">
              ...
              <li>
                Al cancelar, los datos se conservan por 90 días (período de gracia para
                reactivación)
              </li>
          ...
          <section>
            ...
            <p>
              ...
              cambios serán notificados a través de la Plataforma con al menos 15 días de
              anticipación. El uso continuado de la Plataforma después de los cambios constituye la
          ...
          <section>
            ...
            <p>
              ...
              resuelta ante los tribunales de Santiago de Chile.
            </p>
          </section>
