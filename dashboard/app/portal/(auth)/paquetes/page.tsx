...
export default function PaquetesPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Paquetes de Turnos</h1>
        <p className="text-gray-500 mt-1">Ahorrá comprando turnos por adelantado</p>
      </div>
            ...
            >
              ...
              <div className="text-right">
                ...
                <button
                  ...
                  className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50 px-4 py-2 rounded-lg transition-colors"
                >
                  {buyingId === p.id ? (
