...
import { HelpCircle, ChevronDown, Search, Headset, ExternalLink, Scale, Gavel } from 'lucide-react';
...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    icon: Scale,
    description: 'Políticas de privacidad, aviso legal y términos de uso',
    features: [
      {
        id: 'ver-legal',
        title: 'Legal y Cumplimiento',
        icon: Gavel,
        description: 'Política de Privacidad, Aviso Legal y Términos y Condiciones completos',
        steps: [
          'Protección de datos según Ley 19.628 y Ley 21.719',
          'Derechos del paciente según Ley 20.584',
          'Protección al consumidor según Ley 19.496',
          'Ejercicio de derechos ARCO y portabilidad',
        ],
        link: '/portal/legal',
      },
    ],
