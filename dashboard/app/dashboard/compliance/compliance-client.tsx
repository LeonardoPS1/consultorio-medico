...
import { Clock, TrendingUp, TrendingDown, Calendar, AlertTriangle, Users } from 'lucide-react';
import { PageHeader } from '@/components/page-header';
import type { ComplianceData, Periodo } from './types';
...
export function ComplianceClient({ initialData }: Props) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Monitoreo de tiempos de espera y plazos de atención"
        action={
