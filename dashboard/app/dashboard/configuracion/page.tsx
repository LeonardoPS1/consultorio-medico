                ...
                <CardContent className="flex items-center justify-center h-48">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-muted-foreground/70 mt-1">
                      Creá tu primera plantilla de mensaje
                    </p>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <>
                    ...
                    <div className="pt-3">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNotificaciones({ ...notificaciones, whatsappPersonal: e.target.value })
                        }
                        className="mt-1"
                      />
    ...
    <Dialog open={!!plantilla} onOpenChange={() => onClose()}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>Completá las variables para ver el mensaje final</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
          {/* Variables editables */}
