...
export async function PATCH(
  ...
  try {
    ...
    if (body.diagnosticoDescripcion !== undefined) updateData.diagnosticoDescripcion = body.diagnosticoDescripcion;
    if (body.visibleParaPaciente !== undefined) updateData.visibleParaPaciente = body.visibleParaPaciente;
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Error al eliminar entrada de historial' },
      { status: 500 },
    );
  }
}
