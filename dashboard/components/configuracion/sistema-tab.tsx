...
const TOGGLEABLE_FEATURES: ToggleFeature[] = [
  // ─── Módulos principales (sidebar) ───────────────────────
  {
    ...
    description: 'Dashboard principal con KPIs y actividad reciente',
    category: 'modulos',
  },
  {
    id: 'atencion',
    label: 'Atención',
    description: 'Kanban de atención diaria',
    category: 'modulos',
  },
  { id: 'turnos', label: 'Turnos', description: 'Gestión de turnos y agenda', category: 'modulos' },
  {
    id: 'pacientes',
    label: 'Pacientes',
    description: 'Ficha de pacientes y datos de contacto',
    category: 'modulos',
  },
  {
    id: 'conversaciones',
    label: 'Conversaciones',
    description: 'Bandeja de mensajes de WhatsApp',
    category: 'modulos',
  },
  {
    id: 'recetas',
    label: 'Recetas',
    description: 'Prescripciones y recetas digitales',
    category: 'modulos',
  },
  {
    id: 'reportes',
    label: 'Reportes',
    description: 'Estadísticas y reportes del consultorio',
    category: 'modulos',
  },
  {
    id: 'horarios',
  ...
  },
  {
    ...
    description: 'Alertas por WhatsApp y email',
    category: 'modulos',
  },
  {
    id: 'portal-paciente',
    label: 'Portal del Paciente',
    description: 'Acceso web para que pacientes vean turnos y recetas',
    category: 'modulos',
  },
  {
    id: 'encuestas',
    label: 'Encuestas Post-Consulta',
    description: 'Encuestas de satisfacción automáticas por WhatsApp',
    category: 'modulos',
  },
  {
    id: 'pwa',
    label: 'PWA (App Instalable)',
    description: 'Progressive Web App con modo offline y actualizaciones automáticas',
    category: 'modulos',
  },
  {
    id: 'notas-soap',
    label: 'Notas SOAP',
    description: 'Evolución clínica estructurada con CIE-10 en la ficha del paciente',
    category: 'modulos',
  },
  {
    id: 'telemedicina',
  ...
  // ─── Funcionalidades avanzadas ──────────────────────────
  {
    ...
    description: 'Gráficos, exportación Excel y PDF',
    category: 'avanzado',
  },
  {
    id: 'ia-assistant',
  ...
  },
  {
    ...
    description: 'Mensajes predefinidos para recordatorios',
    category: 'avanzado',
  },
  {
    id: '2fa',
    label: 'Autenticación 2FA',
    description: 'Segundo factor de autenticación para médicos',
    category: 'avanzado',
  },
  {
    id: 'equipo',
    label: 'Gestión de Equipo',
    description: 'Múltiples médicos y profesionales',
    category: 'avanzado',
  },
  {
    id: 'credenciales',
    label: 'Credenciales',
    description: 'Gestión de credenciales de servicios externos',
    category: 'avanzado',
  },
  {
    id: 'firma-digital',
    label: 'Firma Digital QR',
    description: 'Hash de verificación SHA-256 en recetas con QR público',
    category: 'avanzado',
  },
  {
    id: 'exportacion',
    label: 'Exportación Excel/PDF',
    description: 'Exportar pacientes y recetas a Excel y PDF',
    category: 'avanzado',
  },
  {
    id: 'certificados-qr',
    label: 'Certificados Médicos QR',
    description: 'Certificados médicos con hash SHA-256 y verificación pública',
    category: 'avanzado',
  },
  {
    id: 'lista-espera',
    label: 'Lista de Espera',
    description: 'Lista de espera inteligente con ofertas automáticas al cancelar turnos',
    category: 'avanzado',
  },
  {
    id: 'multi-sucursal',
    label: 'Multi-sucursal',
    description: 'Múltiples sucursales o consultorios',
    category: 'avanzado',
  },
  {
    id: 'derivaciones',
    label: 'Derivaciones',
    description: 'Derivación de pacientes entre especialistas del equipo',
    category: 'avanzado',
  },
  {
    id: 'blacklist',
    label: 'Lista Negra',
    description: 'Gestión de pacientes bloqueados con motivo y control de acceso',
    category: 'avanzado',
  },
  {
    id: 'alertas-inteligentes',
    label: 'Alertas Inteligentes',
    description: 'Notificaciones proactivas por stock bajo, pacientes críticos y cumpleaños',
    category: 'avanzado',
  },
  {
  ...
  // ─── Sistema ────────────────────────────────────────────
  {
    ...
    description: 'Workflows de automatización avanzados',
    category: 'sistema',
  },
  {
    id: 'api-publica',
  ...
  {
    id: 'backup-encriptado',
    label: 'Backup Encriptado',
    description: 'Respaldo automático encriptado de la BD',
    category: 'sistema',
  },
  {
    id: 'webhooks-log',
    label: 'Log de Webhooks',
    description: 'Registro de llamadas webhook entrantes',
    category: 'sistema',
  },
  {
    id: 'gcal-sync',
    label: 'Google Calendar Sync',
    description: 'Sincronización bidireccional de turnos con Google Calendar',
    category: 'sistema',
  },
  {
    id: 'n8n-monitor',
...
export default function SistemaTab({ isAdmin, section }: SistemaTabProps) {
  ...
  const handleSaveUserOverrides = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast({
          title: 'Overrides de usuario actualizados',
          description: 'Los cambios ya están activos para este usuario.',
        });
        await refreshFeatureFlags();
      } else {
  ...
  return (
    <div className="space-y-6">
      ...
      {(showAll || section === 'toggles') && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Activá o desactivá funcionalidades del sistema. Los cambios se aplican a todo el
              consultorio.
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex-1 relative" ref={userDropdownRef}>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    value={
                      selectedUser ? `${selectedUser.nombre} (${selectedUser.email})` : userSearch
                    }
                    onChange={(e) => {
            ...
            {loadingUserOverrides ? (
              ...
              <div className="space-y-3">
                <div className="text-sm text-muted-foreground">
                  Editando overrides para usuario:{' '}
                  <Badge variant="secondary">{selectedUserId}</Badge>
                </div>
                ...
                <div className="text-xs text-muted-foreground">
                  Nota: Los overrides de usuario tienen máxima prioridad. Si una feature está
                  habilitada aquí, el usuario puede usarla aunque su plan no la incluya.
                </div>
              </div>
            ) : (
      ...
      {/* ─── IA ────────────────────────────────────────────── */}
      {(showAll || section === 'ia') && (
        <IaConfigSection toggles={toggles} handleToggle={handleToggle} />
      )}

      {/* ─── Integraciones ─────────────────────────────────── */}
      {(showAll || section === 'integraciones') && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
      ...
      {(showAll || section === 'credenciales') && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Gestión centralizada de credenciales para servicios externos
            </CardDescription>
          </CardHeader>
          <CardContent>
            <CredencialesTab />
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configuración de retención de datos y privacidad según normativa ARCO (Ley 19.628 Chile /
          Ley 25.326 Argentina / RGPD).
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {loading ? (
          ...
          <>
            <div className="max-w-sm space-y-2">
              <Label htmlFor="retencion-dias">Período de retención post-baja (días)</Label>
              <p className="text-xs text-muted-foreground">
                Tiempo que los datos del paciente se conservan después de confirmar la baja, antes
                de ser anonimizados permanentemente.
              </p>
            ...
            <div className="rounded-lg border border-primary/10 bg-primary/5 p-4 space-y-2">
              ...
              <ul className="text-xs text-muted-foreground space-y-1 list-disc list-inside">
                <li>
                  Cuando un paciente solicita la baja, se registra la solicitud y se le notifica
                </li>
                <li>
                  Al confirmar la baja, sus datos personales se anonimizan inmediatamente (nombre,
                  email, teléfono, RUT)
                </li>
                <li>
                  Los datos clínicos se conservan de forma anonimizada durante el período
                  configurado
                </li>
                <li>
                  Pasado ese período, un job automático (n8n WF-09) elimina definitivamente los
                  datos residuales
                </li>
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setConfig((prev) => ({
                      ...prev,
                      temperatura: parseFloat(e.target.value) || 0.3,
                    }))
                  }
                />
              </div>
