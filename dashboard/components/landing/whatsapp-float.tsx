...
export function WhatsAppFloat() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-green-500 text-white px-5 py-3 shadow-lg shadow-green-500/30 hover:bg-green-600 transition-all duration-200 animate-pulse-glow btn-press"
