  ...
  return (
    <section className="relative overflow-hidden border-t">
      ...
      <div className="relative md:absolute inset-x-0 top-12 md:top-16 flex justify-center pointer-events-none pb-4 md:pb-0">
        <AnimatedSection variant="fade-up" delay={0} className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-primary/70 text-xs sm:text-sm px-4">
      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24 text-center relative">
        <AnimatedSection className="max-w-2xl mx-auto">
          <AnimatedSection variant="scale-in" delay={0.1} className="inline-flex items-center gap-2 rounded-full bg-primary/10 text-primary px-4 py-1.5 text-xs font-medium mb-6">
