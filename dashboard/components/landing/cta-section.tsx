    ...
    <section className="relative overflow-hidden border-t">
      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24 text-center relative">
        ...
        >
          ...
          >
            <Button size="lg" className="text-base h-12 px-8 gap-2 shadow-lg shadow-primary/20 shine-effect btn-press cta-glow-hover transition-all duration-150 active:scale-95" asChild>
